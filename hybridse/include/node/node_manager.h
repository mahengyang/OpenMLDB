...
class NodeManager {
 public:
    ...
    TableRefNode *MakeTableNode(const std::string &db, const std::string &name, const std::string &alias);
    ...
    SqlNode *MakeCreateTableNode(bool op_if_not_exist, const std::string &db_name, const std::string &table_name,
                                 SqlNodeList *column_desc_list, SqlNodeList *partition_meta_list);
