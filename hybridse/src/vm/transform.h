...
class BatchModeTransformer {
 public:
    ...
    Status GenHavingFilter(ConditionFilter* filter, const SchemasContext* schemas_ctx);
 ...
 protected:
    ...
    virtual Status TransformLoadDataOp(const node::LoadDataPlanNode* node, PhysicalOpNode** output);
